...
<div class="d-flex" id="wrapper">
    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="row g-3 my-2">
            ...
            <div class="col-xl col-md-4 col-sm-6">
                <div class="p-4 bg-white shadow-sm d-flex justify-content-between align-items-center rounded-3 dashboard-card border-left-<?php echo $card['color']; ?> h-100">
                    <div>
                        <h3 class="fs-2 mb-1" style="font-family: var(--font-heading); font-weight: 800; color: var(--slate-900);"><?php echo $card['value']; ?></h3>
                        <p class="fs-6 text-muted mb-0 fw-medium"><?php echo $card['label']; ?></p>
                    </div>
                    <div class="rounded-full <?php echo $card['color']; ?>-bg p-3 d-flex align-items-center justify-content-center" style="width: 52px; height: 52px;">
                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h5 class="card-title text-secondary mb-0 fw-bold" style="font-family: var(--font-heading);">
            ...
            <div class="col-lg-7 col-md-12">
                <div class="card shadow-sm border-0 h-100 rounded-4">
                    <div class="card-header bg-white border-0 py-3">
                        <h5 class="mb-0 text-secondary fw-bold" style="font-family: var(--font-heading);">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="progress rounded-pill" style="height: 6px; background-color: var(--slate-100);">
                                        <div class="progress-bar rounded-pill" role="progressbar"
                                             style="width: <?php echo $percentage; ?>%; background-color: var(--primary) !important;"
        ...
        <!-- ═══════════════════════════════════════════
             ...
             ═══════════════════════════════════════════ -->
        <div class="row my-4">
            <h3 class="fs-5 mb-3 fw-bold" style="font-family: var(--font-heading); color: var(--slate-700);">
                <i class="fas fa-bolt me-2 text-warning"></i>Quick Actions
            </h3>
            <?php
            $actions = [
                ['href' => 'products.php',      'icon' => 'fa-box',           'title' => 'Products',     'desc' => 'Add, edit & manage inventory items',       'gradient' => '#6366f1, #818cf8'],
                ['href' => 'orders.php',         'icon' => 'fa-cash-register', 'title' => 'POS Terminal', 'desc' => 'Process sales & purchase orders',          'gradient' => '#10b981, #34d399'],
                ['href' => 'customers.php',      'icon' => 'fa-users',         'title' => 'Customers',    'desc' => 'Manage customer records & contacts',       'gradient' => '#8b5cf6, #a78bfa'],
                ['href' => 'order_history.php',  'icon' => 'fa-chart-bar',     'title' => 'Reports',      'desc' => 'View history & export CSV reports',        'gradient' => '#06b6d4, #22d3ee'],
            ];
            foreach ($actions as $action):
            ?>
            <div class="col-lg-3 col-md-6 mb-3">
                <a href="<?php echo $action['href']; ?>" class="text-decoration-none">
                    <div class="card border-0 h-100 shadow-sm quick-action-card" style="background: linear-gradient(135deg, <?php echo $action['gradient']; ?>); border-radius: var(--radius-lg);">
                        <div class="card-body p-4 text-white">
                            ...
                            <h5 class="fw-bold mb-1" style="font-family:var(--font-heading);color:#fff;"><?php echo $action['title']; ?></h5>
                            <p class="mb-0 small" style="opacity:0.85;"><?php echo $action['desc']; ?></p>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <script>
        window.addEventListener('load', function () {
            ...
            const chartData = <?php echo json_encode($chart_data, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
            ...
            var categoryData = <?php echo json_encode($category_sales, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
