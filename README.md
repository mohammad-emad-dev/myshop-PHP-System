...
- Phase 4F closes the current extraction review: every remaining facade function is inventoried by ownership and caller evidence, extracted modules remain dependency-clean, and the documented Phase 4G candidates are review-only. No legacy function or file is deleted by this phase.
