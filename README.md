...
- Phase 6G closes the remaining login, settings, audit-log, shared-shell, accessibility, and CSS review work. The audit and retention manifest, sanitized evidence, and known modal-keyboard limitation are recorded in [`docs/ui/PHASE-6G-FINAL-UI-CLOSURE-TDD.md`](docs/ui/PHASE-6G-FINAL-UI-CLOSURE-TDD.md).
