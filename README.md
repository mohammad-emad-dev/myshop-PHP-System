...
- Remaining database/business workflows, including authentication rate limiting, staff administration, and customer/supplier writes, remain in the facade or page controllers until a future refactor establishes and tests their dependency boundaries.
